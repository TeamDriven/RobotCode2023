...
public class AutoPlaceConeHigh extends SequentialCommandGroup {
  ...
  public AutoPlaceConeHigh(Intake intake, Elevator elevator, Claw claw) {

    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetClawPositionWaitForFinish(claw, armStartPos),
      new MoveElevatorWaitForFinish(elevator, elevatorUpPos),
      new SetClawPositionWaitForFinish(claw, armPlacePos)
