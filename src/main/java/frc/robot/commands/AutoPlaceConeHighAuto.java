...
public class AutoPlaceConeHighAuto extends SequentialCommandGroup {
  /** Creates a new AutoPlaceConeHigh. */
  public AutoPlaceConeHighAuto(Intake intake, Elevator elevator, Claw claw) {

    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetClawPositionWaitForFinish(claw, armStartPos),
      new MoveElevatorWaitForFinish(elevator, elevatorUpPosAuto),
      new SetClawPositionWaitForFinish(claw, armPlacePosAuto)
