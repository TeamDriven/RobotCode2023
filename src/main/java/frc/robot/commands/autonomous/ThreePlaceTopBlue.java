...
public final class ThreePlaceTopBlue extends SequentialCommandGroup {
  ...
  public ThreePlaceTopBlue(Drivetrain drivetrain, Intake intake, Elevator elevator, Claw claw, LimeLight limeLight) {
    ...
    addCommands(
      ...
      // new WaitCommand(0.1),
      new RunTempIntake(intake, -0.5).withTimeout(0.1),
