...
public class MoveElevatorAndArm extends SequentialCommandGroup {
  ...
  public MoveElevatorAndArm(double elevatorPos, double armPos) {

    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetArmPositionWaitForFinish(armTuckPos), //was arm up pos
      new MoveElevatorWaitForFinish(elevatorPos),
      new SetArmPositionWaitForFinish(armPos)
